...
| Model | Best for |
|-------|----------|
| Claude Sonnet 4 | Everyday coding tasks, good balance of speed and quality |
| Claude Opus 4 | Complex architectural decisions, large refactors |
| GPT-4.1 | General-purpose coding, broad knowledge |
| Gemini 2.5 Pro | Long-context tasks, large codebases |

You can switch models at any time in **Settings → Models & Providers**.
