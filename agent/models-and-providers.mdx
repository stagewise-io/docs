...
You can switch the active model at any time from the model selector in the chat sidebar. The model choice is global — it applies to all new messages across all chats.
